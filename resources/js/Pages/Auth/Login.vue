                    ...
                    <div class="w-full mx-auto p-5">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative flex items-center w-full justify-end">
                                ...
                                <input :type="inputType" id="password" name="password" placeholder="password" class="input focus:outline:white focus:outline-offset-0 shadow-none pl-8" v-model="form.password">
                            </div>
